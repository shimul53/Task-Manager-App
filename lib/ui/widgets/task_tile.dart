          ...
          children: [
            Expanded(
                child: Column(
                  ...
                  children: [
                    Text(taskModel?.title??"",style: GoogleFonts.lato(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("${taskModel!.startTime} - ${taskModel!.endTime}",
                          style: GoogleFonts.lato(textStyle: TextStyle(fontSize: 13,color: Colors.grey[100])),),
                    ...
                    SizedBox(height: 12,),
                    Text(taskModel?.note??"",style: GoogleFonts.lato(textStyle:
